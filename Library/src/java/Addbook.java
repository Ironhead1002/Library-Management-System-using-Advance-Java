    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                    ...
                    PreparedStatement pst = con.prepareStatement("INSERT INTO books (Book_Name, Author_Name, Book_Edition, Quantity) VALUES (?,?,?,?)");
                    ...
                    if(click.equals("Add")){
                        ...
                        pst.setString(1, addbname);
                        pst.setString(2, addaname);
                        pst.setString(3, addbe);
                        pst.setInt(4, addbq);
